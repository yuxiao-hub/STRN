...
class Options:
    ...
    def _initial(self):
        ...
        #                        default='/home/zjj/zjh/cmu/HisRepItself-master/datasets/',
        #                          help='path to dataset')
        self.parser.add_argument('--data_dir', type=str,
                                 default='/datasets/h3.6m/',
                                 help='path to dataset')
        ...
        self.parser.add_argument('--ckpt', type=str, default='checkpoint/main_h36m_3d_in50_out10_ks10_dctn20', help='path to save checkpoint')
